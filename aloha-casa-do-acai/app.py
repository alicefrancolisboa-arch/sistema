...
def scan_invoice():
    ...
    if key:
        try:
            ...
            # gemini-2.0-flash foi descontinuado; 2.5 Flash é o modelo estável com visão.
            req=urllib.request.Request('https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent?key='+key,data=body,headers={'Content-Type':'application/json'})
